	...
	function u(e, t, i) {
		...
		function f(e) {
			...
			return p(), c.push(e),
				function () {
					if (t) {
						if (d) throw new Error("You may not unsubscribe from a store listener while the reducer is executing. ");
						t = !1, p();
						var i = c.indexOf(e);
						c.splice(i, 1)
					}
		...
		ye = {
			...
			item: function (e, t, i) {
				...
				if (Object.assign(v.dataset, {
					...
					g.setAttribute("aria-label", ": '" + l + "'"), g.dataset.button = "", v.appendChild(g)
				}
				return v
			},
...
(function (root, factory) {
	...
	Multiselect.prototype = {
		...
		defaults: {
			...
			enableHTML: false,
			buttonClass: 'btn btn-multi-selection',
			inheritClass: false,
			buttonWidth: 'auto',
