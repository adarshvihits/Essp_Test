...
namespace Hrms.Lite.Essp.Shared.ESSP.MyProfile
{
    public class MyProfile
    {
        ...
        public string ReportingManagerAbsoluteUri { get; set; }
        ...
        public List<MyProfile_Attendance> Attendance { get; set; }
        public List<MyProfile_Salary> Salary { get; set; }
    ...
    public class MyProfile_Attendance
    {
